    ...
    return (
        <section className="w-full bg-darkBlue py-16 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-8 w-full text-center">
                ...
                <p className="text-lg md:text-xl text-gray-300 mb-4 animate-fade-in delay-100">5 years at Ericsson in GenAI, Agentic AI, Machine Learning & Data</p>
                <h2 className="text-base md:text-lg font-semibold text-neonPurple mb-3 animate-fade-in delay-200">AI-Enabled Data Analyst | GenAI & Agentic AI Systems</h2>
                <p className="text-sm md:text-base text-gray-300 mb-8 animate-fade-in delay-300">Building multi-agent GenAI systems that turn enterprise data into grounded, automated answers</p>
                <div className="flex flex-col md:flex-row gap-4 justify-center animate-fade-in delay-500">
                    ...
                    <a href={`${process.env.PUBLIC_URL}/resume.pdf`} className="px-8 py-3 rounded-full bg-transparent text-neonGreen font-bold border-2 border-neonGreen hover:bg-neonGreen hover:text-darkBlue transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-neonGreen" download>Download Resume</a>
